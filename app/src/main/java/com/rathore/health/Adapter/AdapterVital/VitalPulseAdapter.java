...
//import com.example.archi.health.Activity.VitalUpdate.ActivityVitalUpdatePulse;
//import com.example.archi.health.DbHelper.DbHelper;
//import com.example.archi.health.R;

//import com.pierfrancescosoffritti.aytplayersample.Activity.VitalUpdate.ActivityVitalUpdatePulse;
//import com.pierfrancescosoffritti.aytplayersample.DbHelper.DbHelper;
//import com.pierfrancescosoffritti.aytplayersample.R;
import com.rathore.health.Activity.VitalUpdate.ActivityVitalUpdatePulse;
...
public class VitalPulseAdapter  extends RecyclerView.Adapter<VitalPulseAdapter.Holder> {
    ...
    public VitalPulseAdapter(Context context, List<HashMap<String, String>> PulseArray) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.vital_adapter_pulse, parent, false);
    ...
    public void onBindViewHolder(final Holder holder, final int position) {
        final HashMap<String, String> map = PulseArray.get(position);
        holder.itempdate.setText(map.get("v_pulse_date"));
        holder.itemptime.setText(map.get("v_pulse_time"));
        holder.itemptype.setText(map.get("v_pulse_pulse"));
        holder.itempunit.setText(map.get("v_pulse_unit"));
//        holder.itemllout.setOnClickListener(new View.setOnClickListener() {
//            @Override
...
//        });
        ...
        holder.ellipse.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                deleteRecordComfirmation(map.get("v_pulse_id"),position);
    ...
    private void openPopup(final int position) {
        HashMap<String, String> map = PulseArray.get(position);
        Intent upIntent = new Intent(context, ActivityVitalUpdatePulse.class);
        upIntent.putExtra("v_pulse_id", map.get("v_pulse_id"));
        upIntent.putExtra("v_pulse_date", map.get("v_pulse_date"));
        upIntent.putExtra("v_pulse_time", map.get("v_pulse_time"));
        upIntent.putExtra("v_pulse_pulse", map.get("v_pulse_pulse"));
        upIntent.putExtra("v_pulse_unit", map.get("v_pulse_unit"));
    ...
    public class Holder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.vital_adpter_pulse_txtdate )
        TextView itempdate;
        @BindView(R.id.vital_adpter_pulse_txttime )
        TextView itemptime;
        @BindView(R.id.vital_adpter_pulse_txttype )
        TextView itemptype;
        @BindView(R.id.vital_adpter_pulse_txtunit )
        TextView itempunit;
        @BindView(R.id.vital_adpter_pulse_llout )
